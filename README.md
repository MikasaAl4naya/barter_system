Вот обновленный файл `README.md`, в котором добавлена информация о необходимости выполнения команды `collectstatic` для сбора статических файлов, а также включены команды для удаления папки `static` из репозитория:
